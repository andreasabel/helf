...
\\ 
& \pa{x \sspace \vec v} \ap w & = & h \sspace \ve{\vec v, w} 
\\ \noalign{\medskip}
...
We still have to prove two important facts about the evaluation algorithm given in section \ref{eval} - first, its termination properties and second, its correctness, i.e. it corresponds to beta reduction. 
