...
requires a large amount of evaluation, since types my depend on
...
scope rather than to only to those that are actually refered to in the
...
environments are described in Section~\ref{sec:values}, follows by
...
environment to the variables actually occuring free in the code.
...
% TODO decide: x or y = k ?!? x.
% TODO ordered application is sometimes invalid! yes, but not a problem i think.
% TODO evaluation bleibt nicht stecken - done.
